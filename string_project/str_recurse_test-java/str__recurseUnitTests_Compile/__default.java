...
public class __default {
  ...
  public static dafny.DafnySequence<? extends Character> test1()
  {
    dafny.DafnySequence<? extends Character> r0 = dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR);
    if(true) {
      dafny.DafnySequence<? extends Character> _out3;
      _out3 = M_Compile.__default.replaceRecursive(dafny.DafnySequence.of('a', 'a', 'a'), dafny.DafnySequence.of('a', 'a'), dafny.DafnySequence.of('a'));
      r0 = _out3;
    }
    return r0;
  }
  public static dafny.DafnySequence<? extends Character> test2()
  {
    ...
    if(true) {
      ...
      _out4 = M_Compile.__default.replaceRecursive(dafny.DafnySequence.of('a'), dafny.DafnySequence.of('a', 'a'), dafny.DafnySequence.of('a'));
      r0 = _out4;
    }
    return r0;
  }
