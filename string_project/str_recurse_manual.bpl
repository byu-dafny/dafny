// Dafny 3.2.0.30713
// Command Line Options: ./string_project/str_recurse.dfy /print:string_project/str_recurse_manual.bpl
...
procedure Impl$$M.__default.foo(a#0: int, b#0: int) returns (c#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires b#0 > 5;
  modifies $Heap, $Tick;
...
implementation Impl$$M.__default.foo(a#0: int, b#0: int) returns (c#0: int, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;

    // AddMethodImpl: foo, Impl$$M.__default.foo
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/workspaces/dafny/string_project/str_recurse.dfy(5,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /workspaces/dafny/string_project/str_recurse.dfy(6,5)
    assume true;
    assert (a#0 > 10) == Lit(false);
    // ----- assert statement ----- /workspaces/dafny/string_project/str_recurse.dfy(7,5)
    assume true;
    assert false;
    // ----- return statement ----- /workspaces/dafny/string_project/str_recurse.dfy(8,5)
    // ----- assignment statement ----- /workspaces/dafny/string_project/str_recurse.dfy(8,5)
    assume true;
    assume true;
    c#0 := b#0;
    assume {:captureState "/workspaces/dafny/string_project/str_recurse.dfy(8,12)"} true;
    return;
}
